-- =====================================================
-- Script de Migração para Produção - DBManager v2.0 (FINAL)
-- =====================================================
-- Data: 2025-01-29
...
-- =====================================================
-- 11. VACUUM (EXECUTAR SEPARADAMENTE APÓS O COMMIT)
-- =====================================================
-- IMPORTANTE: Executar estes comandos APÓS o COMMIT acima
...
SELECT
    'Verificação de Migração' as titulo,
    '========================' as separador;
...
SELECT 'Total de índices em sync_discrepancies: ' || COUNT(*) as info
FROM pg_indexes WHERE tablename = 'sync_discrepancies';

SELECT 'Total de triggers ativos: ' || COUNT(*) as info
FROM pg_trigger WHERE tgisinternal = false;

SELECT 'Total de funções personalizadas: ' || COUNT(*) as info
FROM pg_proc
WHERE pronamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')
AND proname LIKE '%license%' OR proname LIKE '%discrepancy%';

-- =====================================================
-- ROLLBACK SCRIPT (salvar separadamente caso necessário)
-- =====================================================
/*
-- ATENÇÃO: Só executar se precisar reverter a migração!
